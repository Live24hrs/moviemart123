...
import Banner160x600 from '@/components/ads/Banner160x600'

export const metadata: Metadata = {
  title: 'MovieMart Lite',
  description: 'Movie discovery + download flow.',
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid lg:grid-cols-[1fr_180px] gap-6 items-start">
            ...
            <aside className="hidden lg:block sticky top-24 space-y-4">
              <Banner160x300 />
              <Banner160x600 />
              <div className="opacity-70 text-[11px] text-slate-500 text-center">Advertisement</div>
            </aside>
          </div>
        </main>
