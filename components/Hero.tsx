    ...
    <div className="relative overflow-hidden card bg-gradient-to-br from-white via-indigo-50 to-fuchsia-50 p-8 sm:p-12">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="relative">
        <div className="inline-flex items-center gap-2 chip">
          ...
          Instagram DM checkout • Instant replies
        </div>

        <h1 className="mt-5 text-4xl sm:text-5xl font-extrabold leading-tight">
          Find any movie fast — <span className="bg-gradient-to-r from-indigo-700 to-fuchsia-700 bg-clip-text text-transparent">DM & get it FREE</span>.
        </h1>
        <p className="mt-4 text-slate-600 max-w-2xl">
          Search the online catalog, open details, then DM us on Instagram to get it for <span className="font-semibold">FREE</span>.
        </p>
